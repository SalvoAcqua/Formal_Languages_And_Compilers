...
token1 = (a|b|c){7}((a|b|c){2})*\#{hexNum}?

hexNum = ((\-5[caCA86420]) | (\-[1-4][02468aceACE]) | (\-[02468aceACE]) | ([02468aceACE]) | ([1-9a-fA-F][02468aceACE]) | ([1-9][0-9a-fA-F][02468aceACE]) | ([aA][0-9aA][02468aceACE]) | ([aA][bB][0246]) )
...
token2 = {myDate}\:{binary}

myDate = ((07\:13\:2[4-9]) | (07\:13\:[3-5][0-9]) | (07\:1[4-9]\:[0-5][0-9]) | (07\:[2-5][0-9]\:[0-5][0-9]) | (0[8-9]\:[0-5][0-9]\:[0-5][0-9]) | (1[0-6]\:[0-5][0-9]\:[0-5][0-9]) | (17\:[0-2][0-9]\:[0-5][0-9]) | (17\:3[0-6]\:[0-5][0-9]) | (17\:37\:[0-3][0-9]) | (17\:37\:4[0-3]) )

binary = ((101) | (11[01]) | (1[01][01][01]) | (10[01][01][01]) | (110[0][01]) | (11010) )
